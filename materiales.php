        ...
        <li class="nav-item active">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active" href="materiales.php">Materiales</a>
            </div>
          </div>
        </li>
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            >
              <h1 class="h3 mb-0 text-gray-800">Gastos de materiales</h1>
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
				...
				$sql=("SELECT * FROM gastosmanoobra where gastos=1");
